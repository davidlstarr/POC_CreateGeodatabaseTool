# -*- coding: utf-8 -*-
"""
Create a master geodatabase and corresponding datasets based on a text file
"""
...
a = open(dataset_array,"r")
GetTextFile = a.readlines()

TextFile = [x.replace('\n', '') for x in GetTextFile]
...
for dataset_array_layers in TextFile:
